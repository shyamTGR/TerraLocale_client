...
import ChatbotIcon from '../../shared/assets/chatbot.png'; // Path to your chatbot icon
        ...
        <div className={styles['wrapper']}>
            <div className={styles['hero']}>
                <div className={styles['hero-text']}>
                    <h1>Now Use our AI shopping assistant to enhance your shopping experience</h1>
            ...
            {/* Chatbot Icon */}
            <img src={ChatbotIcon} className={styles['chatbot-icon']} alt="Chat with us" onClick={toggleChatbot} />
            ...
            <iframe
                ...
                style={{ transform: showChatbot ? 'translateX(0)' : 'translateX(100%)', opacity: showChatbot ? 1 : 0 }}
            />
        </div>
    );
}
